...
let
  ...
  conkyConfig = pkgs.writeText "conky.conf" ''
    ...
    ''${goto 40}''${color #${colors.light}}root:''${goto 140}''${color} ''${fs_used /}/''${fs_size /}''${goto 440}''${color #${colors.light}}Interface:''${goto 540}''${color} ''${if_up enp3s0}enp3s0''${else}''${if_up wlp2s0}wlp2s0''${else}offline''${endif}''${endif}''${goto 840}''${color #${config.colorScheme.palette.base04}}Name''${goto 990}CPU%''${goto 1060}MEM%
