...
- **rog**, **thinkcentre** (MATE): Materia-dark-compact GTK + Adwaita Dark
  Qt style + Papirus-Dark icons, configured via `home-linux/theme.nix`.
- **t14** (Hyprland/Omarchy): Same theme configuration via host-specific
  overrides in `hosts/t14/home/omarchy.nix`.
