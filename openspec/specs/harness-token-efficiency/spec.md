...
The system MUST expose pinned `pkgs.rtk` 0.41.0 through `lib/packages.nix` and install it for rog, thinkcentre, t14, and macm5 without adding a flake input.

#### Scenario: RTK is available on every pilot host [hosts: rog, thinkcentre, t14, macm5]
...
#### Scenario: Telemetry is disabled while local gain works [hosts: rog, thinkcentre, t14, macm5]
...
#### Scenario: Plugin rewrites or passes through safely [hosts: rog, thinkcentre, t14, macm5]
...
#### Scenario: Existing Claude settings survive [hosts: rog, thinkcentre, t14, macm5]
...
#### Scenario: Measurement covers the agreed workload [hosts: rog, thinkcentre, t14, macm5]
...
#### Scenario: Operator can evaluate and disable the pilot [hosts: rog, thinkcentre, t14, macm5]
...
#### Scenario: Single revert restores the baseline [hosts: rog, thinkcentre, t14, macm5]
...
#### Scenario: Scoped repository gates pass [hosts: rog, thinkcentre, t14, macm5]
