...
- THEN the resolved model MUST be one of: `kimi-k2.6`, `deepseek-v4-pro`, `deepseek-v4-flash`
...
- WHEN any SDD phase requests its model assignment
- THEN the resolved model MUST be one of: `kimi-k2.6`, `deepseek-v4-pro`, `deepseek-v4-flash`, `glm-5.2`
- AND no phase MAY resolve to a zombie Qwen model
