# Delta Spec: orchestrator-runtime — opencode-review-policy-enforcement

## Purpose

Requirements for the `Review-Checkpoint Gate` section that MUST be added to
`sdd-orchestrator.md` (runtime: `~/.config/opencode/sdd-orchestrator.md`;
source: `shared/opencode/assets/opencode/sdd-orchestrator.md`).

This domain did not exist before this change. All requirements below are ADDED.
