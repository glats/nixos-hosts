...
git operation in ~/dev/personal-repo/
  └── Git reads ~/.gitconfig
      ├── [user] name="Juan Cuzmar", email="jcuzmar@protonmail.com"   ← DEFAULT
      ├── [includeIf "gitdir:~/Work/**"] → condition NOT matched
      └── RESULT: glats identity

git operation in ~/Work/falabella-repo/
  └── Git reads ~/.gitconfig
      ├── [user] name="Juan Cuzmar", email="jcuzmar@protonmail.com"   ← OVERRIDDEN
      ├── [includeIf "gitdir:~/Work/**"] → condition MATCHED
      │   └── [user] name="jcuzmar", email="jcuzmar@falabella.cl"     ← WINS
...
git operation in ~/dev/work-repo/
  └── Git reads ~/.gitconfig
      ├── [user] name="jcuzmar", email="jcuzmar@falabella.cl"         ← DEFAULT
...
git operation in ~/Personal/glats-repo/
  └── Git reads ~/.gitconfig
      ├── [user] name="jcuzmar", email="jcuzmar@falabella.cl"         ← OVERRIDDEN
      ├── [includeIf "gitdir:~/Work/**"] → condition NOT matched
      ├── [includeIf "gitdir:~/Personal/**"] → condition MATCHED
      │   └── [user] name="Juan Cuzmar", email="jcuzmar@protonmail.com" ← WINS
      └── RESULT: glats identity
```
...
**Before**: Single identity (Juan Cuzmar / jcuzmar@protonmail.com), no includes.
