...
Refactor git identity configuration across all four hosts to support automatic identity switching via `programs.git.includes` with inline `contents`. Linux hosts default to glats (Juan Cuzmar / jcuzmar@protonmail.com) and switch to jcuzmar for work repos. macOS defaults to jcuzmar (jcuzmar@falabella.cl) and switches to glats for personal repos.
...
- **user.email**: MUST be "jcuzmar@falabella.cl"
...
- **user.name**: MUST be "Juan Cuzmar"
- **user.email**: MUST be "jcuzmar@protonmail.com"
...
WHEN  they run `git config user.email`
THEN  the output MUST be "jcuzmar@protonmail.com"
...
After:
- Default identity MUST remain jcuzmar with email jcuzmar@falabella.cl
